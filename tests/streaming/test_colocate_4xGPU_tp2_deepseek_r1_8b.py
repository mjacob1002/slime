"""Baseline: synchronous colocated train.py with TP=2 on 4 GPUs, DeepSeek-R1-Distill-Llama-8B.

Replays the same response lengths as the streaming run for fair comparison.
With TP=2 on 4 GPUs: 2 colocated engine+actor pairs, each TP=2, DP=2.
"""
import os
...
def execute():
    ...
    ci_args = (
        ...
        "--perfetto-trace-path /tmp/colocate_4gpu_tp2_deepseek8b_trace.json "
