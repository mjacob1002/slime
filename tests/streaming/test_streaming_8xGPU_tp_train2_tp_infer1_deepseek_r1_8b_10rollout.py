...
10 rollouts. No migration (default policy = none).
...
Mirrors test_streaming_4xGPU_tp_train2_tp_infer1_deepseek_r1_8b.py scaled to
8 GPUs, batch sizes from test_streaming_8xGPU_tp2_deepseek_r1_8b.py, with
--num-rollout bumped from 3 to 10 and the topology-matched lengths file.
"""
import os
